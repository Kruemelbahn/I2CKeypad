 ...
 *
 *  originally taken from: http://arduino.cc/playground/Main/I2CPortExpanderAndKeypads 
 *  changes by Michael Zimmermann <http://www.kruemelsoft.privat.t-online.de> (21.12.2016):
 *  'PIN MAPPING' and 'num_cols' changed for elecrow 4x4-keypad 
 *
 */
 ...
 *  Mapping is for elecrow 4x4 keypad
 */

#define COL0  4  // P4 of PCF8574, col0 is usually pin 5 of 4x4 keypads
#define COL1  5  // P5 of PCF8574, col1 is usually pin 6 of 4x4 keypads
#define COL2  6  // P6 of PCF8574, col2 is usually pin 7 of 4x4 keypads
#define COL3  7  // P7 of PCF8574, col3 is usually pin 8 of 4x4 keypads
#define ROW0  0  // P0 of PCF8574, row0 is usually pin 1 of 4x4 keypads
#define ROW1  1  // P1 of PCF8574, row1 is usually pin 2 of 4x4 keypads
#define ROW2  2  // P2 of PCF8574, row2 is usually pin 3 of 4x4 keypads
#define ROW3  3  // P3 of PCF8574, row3 is usually pin 4 of 4x4 keypads
...
void i2ckeypad::setAddr(int addr)
{
  pcf8574_i2c_addr = addr;
}
